...
Je m'appelle CHER Naïck, je suis étudiant en troisième année de BUT Informatique à Orléans.
Au cours de mes différents projets, universitaires comme personels, j'ai pu développer mes compétences dans le domaine de l'applicatif, notamment en programmation, base de données, expérience et interface utilisateur, et en gestion de projet.
